...
class Terkey:
  ...
  def about(self):
    ...
    {a}https://wa.me/+62813-8600-8628{c}
  ...
  {a}3.{c} About
    ...
    if menu == "1":
      ...
      pass
    #print(c+'Silahkan hubungi '+a+'https://wa.me/+62813-8600-8628'+c+' jika ada yang mau di bicarakan terkait tool ini, bisnis atau sekedar bertanya kabar. :v\nTerimakasih ^_^')
